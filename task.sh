...
#   dir3
#       dir4
# честно говоря, я уже несколько запустался
# мы в действии ниже создаем в корне директорию task
# с подкаталогами
# которую впоследствии удаляем
...
# изначально мы создавали task в корне
# значит переход в корень = родительская директория
cd /
